  ...
  return (
    <section className="px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <p className="text-xs font-bold uppercase tracking-[0.38em] text-accent-purple">What We Offer</p>
        <div className="mt-7 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {offers.map((offer, index) => (
            <article key={`${offer.title}-${index}`} className="rounded-[22px] border border-[var(--border-soft)] bg-panel-soft p-6">
