  ...
  return createPortal(
    ...
    >
      <div className="relative aspect-video w-[min(calc(100vw-24px),calc(70vh*16/9))] overflow-hidden rounded-[18px] border border-white/15 bg-black shadow-2xl sm:w-[min(85vw,1100px,calc(80vh*16/9))]">
        <button ref={closeRef} type="button" onClick={onClose} aria-label="Close video" className="absolute right-3 top-3 z-[10] flex h-[38px] w-[38px] items-center justify-center rounded-full border border-violet-400/70 bg-black/75 text-white shadow-[0_0_16px_rgba(255,77,0,0.45)] backdrop-blur-md transition hover:border-violet-300 hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-violet-400 sm:h-[42px] sm:w-[42px]">
          <X size={22} />
        </button>
