  ...
  return (
    <section className="px-6 py-16">
      <div className="mx-auto max-w-7xl">
        <p className="text-xs font-bold uppercase tracking-[0.38em] text-cyan-300">Our Process</p>
        <div className="mt-8 grid gap-4 lg:grid-cols-4">
          {steps.map((step, index) => (
            <article key={`${step.title}-${index}`} className="relative rounded-2xl border border-white/10 bg-[#0b1020]/72 p-6">
