  ...
  const cardContent = (
    <>
      <div className="relative">
        ...
        <div className="absolute left-4 top-4 inline-flex h-11 w-11 items-center justify-center rounded-2xl border border-white/12 bg-[var(--bg-elevated)] text-white shadow-[0_16px_32px_rgba(0,0,0,0.28)] backdrop-blur-md">
          <Icon size={20} />
        </div>
      </div>
      <div className="p-6">
        ...
        <span className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-[var(--accent-purple)] transition group-hover:text-purple-200">
          View service
