        ...
        {loading ? (
          ...
          <>
            <section className="relative overflow-hidden px-6 pb-16 pt-32 md:pt-36">
              <div className="cinematic-card mx-auto grid max-w-6xl gap-8 px-6 py-8 md:px-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,1fr)] lg:items-center lg:gap-12 xl:gap-14">
